...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  ven. 11 déc. 2020 à 00:14
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  PRIMARY KEY (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='rank values = string = admin, reviewer, chief_editor';
...
(6, 'papa_joueur', '$2y$10$G7a94K26Bvfx3S0toorgJ.ifT3C64XeaFqvKQNOZkr.zOwV2XfaNi', 'mikado842@gmail.com', '0'),
(7, 'user01', '$2y$10$ijuMVMUH8qfI6HKTRV.GzujzRmw.YjGQAbncBx8XknpF/nTHg3Pxq', 'test@test.com', '1'),
(8, 'user02', '$2y$10$rDzR8G3vWWNn0YjAnyqsT.LaSaOqzWw3Bu.iw4obEorZ6Se58/dxO', 'test@test.com', '2'),
(12, 'user03', '$2y$10$VpCTr.Flf5aD7ogaR9a2F.BSQpdgICUfuRZ1R8TvHXbfxUnlNeqF6', 'test@test.com', '2');
...
ALTER TABLE `comments`
  ...
  ADD CONSTRAINT `fk_user` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `reviews`
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `fk_user_id` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
