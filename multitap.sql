...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  ven. 23 oct. 2020 à 17:11
...
INSERT INTO `comments` (`id`, `review_id`, `pseudo`, `content`, `thumbs_up`, `thumbs_down`, `comment_date`) VALUES
(1, 1, 'Don Diego de la Vega', 'Donec feugiat blandit eros eu egestas. Quisque tempor feugiat venenatis. Donec dui sapien, luctus ac consequat eu, luctus eget augue. Nam magna ante, scelerisque vel est at, porta accumsan erat. Ut eros lorem, dictum in urna ac, pretium dignissim lorem.', 2, 1, '0000-00-00'),
(2, 1, 'Jean de la Fontaine', 'Donec feugiat blandit eros eu egestas. Quisque tempor feugiat venenatis. Donec dui sapien, luctus ac consequat eu, luctus eget augue. Nam magna ante, scelerisque vel est at, porta accumsan erat. Ut eros lorem, dictum in urna ac, pretium dignissim lorem.', 12, 0, '0000-00-00'),
(3, 2, 'Long John Silver', 'Donec feugiat blandit eros eu egestas. Quisque tempor feugiat venenatis. Donec dui sapien, luctus ac consequat eu, luctus eget augue. Nam magna ante, scelerisque vel est at, porta accumsan erat. Ut eros lorem, dictum in urna ac, pretium dignissim lorem.', 41, 12, '0000-00-00'),
(4, 5, 'Jackie Chan', 'Donec feugiat blandit eros eu egestas. Quisque tempor feugiat venenatis. Donec dui sapien, luctus ac consequat eu, luctus eget augue. Nam magna ante, scelerisque vel est at, porta accumsan erat. Ut eros lorem, dictum in urna ac, pretium dignissim lorem.', 0, 16, '0000-00-00');
